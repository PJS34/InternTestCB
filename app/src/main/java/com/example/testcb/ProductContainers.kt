...
class ProductContainers {
    var ProductMap : HashMap<Int,Array<LocalDate>>

    init {
        ProductMap = HashMap<Int,Array<LocalDate>>()
        val ExpiryDate1 = arrayOf(
            LocalDate.of(2018, 11, 5),
            LocalDate.of(2018, 11, 3),
            LocalDate.of(2018, 11, 2)

        )
        val ExpiryDate2 = arrayOf(
            LocalDate.of(2018, 6, 10),
            LocalDate.of(2018, 6, 6)
        )
        val ExpiryDate3 = arrayOf(
    ...
    fun addProduct(GTIN : Int,ExpiryDates : Array<LocalDate>){
